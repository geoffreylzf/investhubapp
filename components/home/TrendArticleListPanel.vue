<template>
  <div class="panel">
    <div class="panel-title">Trending Articles</div>
    ...
    <div v-else class="content">
      <div v-for="(art, i) in articleList" :key="i" class="article">
        ...
        <p class="author">{{ art.author_first_name }}. Publish Date</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  async mounted() {
    this.articleList = (await this.$axios.get('/api/home/trend-articles/')).data
